<template>
    <div class="max-width">
      ...
      <p>
        - Ver tu Lista por: <router-link to="/">
        <a>Producto</a>
      </router-link> | <router-link to="/full">
        <a>Full</a>
      </router-link>
      </p>
      ...
      <table>
        ...
        <tbody>
          <tr v-for="product in filteredProducts" :key="product.id">
            ...
            <td>
              <a class="sbox-modal" @click="openAddBatchModal(product.id)">Add</a>
              -
              <a class="sbox-modal" @click="openBatchModal(product.code)">View</a>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    >
      <div class="modal__content">
        ...
        <p v-else>No batches available for this product.</p>
      </div>
    </Modal>
  </template>
